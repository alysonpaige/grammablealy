...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    ...
    it "should return a 404 msg if we cannot find a gram with the id that is specified" do
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe "grams#edit action" do
    it "shouldn't let a user who did not create the gram edit a grab" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
